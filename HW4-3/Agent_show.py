...
from lib.shower import ACShower
...
def init_parser(main):
    ...
    parser.add_argument('--sample_times', type = int, default = 8, help = 'How many games to check a checkpoint model.')
...
if __name__ == '__main__':
    ...
    shower = ACShower(opt.model_type, opt.model_name, observation_dict, opt.device)
