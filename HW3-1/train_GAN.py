...
def init_parser(main):
    ...
    parser.add_argument('--switch_ratio', type = int, default = 2, help = 'the switch ratio of training generator and discriminator')
    parser.add_argument('--epochs', type = int, default = 4000, help = 'number of epochs of training.')
